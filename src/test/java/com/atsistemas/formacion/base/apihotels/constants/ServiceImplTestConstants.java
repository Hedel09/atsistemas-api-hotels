...
public class ServiceImplTestConstants {
	...
	protected static final Availability TEST_AVAILABILITY_1 = new Availability(DEFAULT_AVAILABILITY_ID_1, LocalDate.of(2024, 10, 23), 10, DEFAULT_HOTEL_ID_1);
	protected static final Availability TEST_AVAILABILITY_2 = new Availability(DEFAULT_AVAILABILITY_ID_2, LocalDate.of(2024, 10, 24), 20, DEFAULT_HOTEL_ID_1);
	protected static final Availability TEST_AVAILABILITY_3 = new Availability(DEFAULT_AVAILABILITY_ID_3, LocalDate.of(2024, 10, 25), 20, DEFAULT_HOTEL_ID_1);
	...
	protected static final Booking TEST_BOOKING_1 = new Booking(DEFAULT_BOOKING_ID_1, LocalDate.of(2024, 10, 23), LocalDate.of(2024, 10, 25), "test1@mail.com", DEFAULT_HOTEL_ID_1);
	protected static final Booking TEST_BOOKING_2 = new Booking(DEFAULT_BOOKING_ID_2, LocalDate.of(2024, 10, 24), LocalDate.of(2024, 10, 26), "test2@mail.com", DEFAULT_HOTEL_ID_1);
	protected static final Booking TEST_BOOKING_3 = new Booking(DEFAULT_BOOKING_ID_3, LocalDate.of(2024, 10, 25), LocalDate.of(2024, 10, 27), "test3@mail.com", DEFAULT_HOTEL_ID_1);
	protected static final Booking TEST_BOOKING_WRONG_DATES = new Booking(DEFAULT_BOOKING_ID_1, LocalDate.of(2024, 10, 25), LocalDate.of(2024, 10, 23), "test4@mail.com", DEFAULT_HOTEL_ID_1);
	protected static final Booking TEST_BOOKING_PAST_DATES = new Booking(DEFAULT_BOOKING_ID_1, LocalDate.of(2021, 10, 23), LocalDate.of(2021, 10, 25), "test5@mail.com", DEFAULT_HOTEL_ID_1);
